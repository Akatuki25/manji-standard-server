...
for (const svc of model.services) {
  ...
  write("src/app/" + s + "s/page.tsx", pageList(E, s));
  write("src/app/" + s + "s/new/page.tsx", pageNew(E, s));
  write("src/app/" + s + "s/[id]/page.tsx", pageDetail(E, s));
  write("src/app/" + s + "s/[id]/edit/page.tsx", pageEdit(E, s));
}
